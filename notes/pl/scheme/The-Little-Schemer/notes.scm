...
;; It must be changed to be closer to termination.The changing argument must be tested in termination condition:
;; When using car, test termination with null?
;; When using sub1, test termination with zero?.

;; (5). When building a value with +, always use 0 for the value of the terminating lien, for adding 0 does not change the value of an addition.
